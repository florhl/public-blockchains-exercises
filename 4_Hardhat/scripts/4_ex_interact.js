...
const contractAddress = "0x856b7e480a8526Bb6599Caa5dF1a875aB9b01c79";
...
async function main() {
  ...
  //ProviderError: execution reverted: You can't withdraw yet
  ...
  const withdrawAttempt1 = async (lockContract = lock) => {
    ...
    const response = await lockContract.withdraw();
  ...
  const withdrawAgain = async() => {
    ...
    const newContractAddress = "0x12A05D93Bbc434BcA6Be9A47498464Cc6f11C8F4";
  ...
  //ProviderError: execution reverted: You aren't the owner
  ...
  const triggerNotOwner = async () => {
    ...
    const thirdContractAddress = "0x12A05D93Bbc434BcA6Be9A47498464Cc6f11C8F4";
    const nonOwner = new ethers.Wallet(process.env.METAMASK_2_PRIVATE_KEY,
      provider);
